...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      <Ionicons name="chevron-down" aria-hidden={true} className="text-muted-foreground size-4" />
    </SelectPrimitive.Trigger>
  );
}
    ...
    <SelectPrimitive.Item
      ...
      <View className="absolute right-2 flex size-3.5 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          ...
          <AntDesign name="check" aria-hidden={true} className="text-muted-foreground size-4 shrink-0" />
        </SelectPrimitive.ItemIndicator>
      </View>
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      <Ionicons name="chevron-up" aria-hidden={true} className="size-4" />
    </SelectPrimitive.ScrollUpButton>
  );
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      <Ionicons name="chevron-down" aria-hidden={true} className="size-4" />
    </SelectPrimitive.ScrollDownButton>
  );
}
